...
python preprocess.py -train_src data/train.de.eat -train_tgt data/train.de.plain -valid_src data/dev.de.eat -valid_tgt data/dev.de.plain -save_data data/eat_de-plain_de -src_vocab_size 15000 -tgt_vocab_size 15000
